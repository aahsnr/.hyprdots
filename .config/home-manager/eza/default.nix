# eza with Catppuccin Mocha theme configuration for home-manager
# This module configures eza with the Catppuccin Mocha color scheme
{ config, lib, pkgs, ... }:

with lib;

{
  # Enable eza with proper configuration
  programs.eza = {
    enable = true;
    
    # Enable icons (boolean value)
    icons = true;
    ...
    # Extra options for enhanced functionality
    extraOptions = [
  ...
  # Create the Catppuccin Mocha theme configuration file
